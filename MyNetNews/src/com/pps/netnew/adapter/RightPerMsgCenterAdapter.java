...
public class RightPerMsgCenterAdapter extends BaseAdapter {
	...
	public RightPerMsgCenterAdapter(Context pContext,List<ItemPerMsgCenterModel> pLists)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		{
			_Holder=new Holder();
			convertView=mLayoutInflater.inflate(R.layout.right_per_msg_center_item, null);
