...
public class LeftCateGoryAdapter extends BaseAdapter {
	...
	public View getView(int arg0, View view, ViewGroup arg2) {
		...
		if(null==view)
		{
			...
			_Holder.left_category_item_img=(ImageView)view.findViewById(R.id.left_category_item_img);
			_Holder.left_category_item_name=(TextView)view.findViewById(R.id.left_category_item_name);
			_Holder.left_category_item_title=(TextView)view.findViewById(R.id.left_category_item_title);
			view.setTag(_Holder);
		}else {
			_Holder=(Holder)view.getTag();
		}
		_Holder.left_category_item_img.setImageResource(mLists.get(arg0).getId());
